    ...
    <ul className="navigation">
      {/* <li className="navigation-item">
        <Link href={navigatorData.HOME.href}>
          <a className="navigation-item__title">{"Products"}</a>
        </Link>
      ...
      <li className="navigation-item">
        <Link
          legacyBehavior
          href={process.env.NEXT_PUBLIC_URL + navigatorData.HOME.href}
        >
      ...
      <li className="navigation-item">
        <Link
          legacyBehavior
          href={process.env.NEXT_PUBLIC_URL + navigatorData.PRODUCTS.href}
        >
          <a className="navigation-item__title">
            {navigatorData.PRODUCTS.title}
          </a>
        </Link>
      </li>
      <li className="navigation-item">
        <Link
          legacyBehavior
          href={process.env.NEXT_PUBLIC_URL + navigatorData.BLOG.href}
        >
          <a className="navigation-item__title">{navigatorData.BLOG.title}</a>
        </Link>
      </li>
      <li className="navigation-item">
        <Link
          legacyBehavior
          leg
          href={process.env.NEXT_PUBLIC_URL + navigatorData.ABOUT.href}
        >
