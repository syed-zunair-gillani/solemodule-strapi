...
const initialState = {
  ...
  soleModuleProducts: { loading: true, data: [], error: false },
  ...
  soleProductDetail: { loading: true, data: {}, error: false },
};
...
export default function shopReducer(state = initialState, action) {
  switch (action.type) {
    ...
    //Sole Module products
    case SHOP.FETCH_SOLE_MODULE_PRODUCTS:
      return {
        ...state,
        soleModuleProducts: { loading: true, data: [], error: false },
      };
    case SHOP.FETCH_SOLE_MODULE_PRODUCTS_SUCCESS:
      return {
        ...state,
        soleModuleProducts: {
          ...state.soleModuleProducts,
          loading: false,
          data: action.payload.data,
        },
      };
    case SHOP.FETCH_SOLE_MODULE_PRODUCTS_FAIL:
      // let { err } = action.payload;
      return {
        ...state,
        soleModuleProducts: {
    ...
    //Sole Product detail
    case SHOP.FETCH_SOLE_PRODUCT_DETAIL:
      return {
        ...state,
        soleProductDetail: { loading: true, data: [], error: false },
      };
    case SHOP.FETCH_SOLE_PRODUCT_DETAIL_SUCCESS:
      return {
        ...state,
        soleProductDetail: {
          ...state.soleProductDetail,
          loading: false,
          data: action.payload.data,
        },
      };
    case SHOP.FETCH_SOLE_PRODUCT_DETAIL_FAIL:
      // let { err } = action.payload;
      return {
        ...state,
        soleProductDetail: {
